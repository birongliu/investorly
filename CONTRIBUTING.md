...
Please follow the guidelines below to make the contribution process smooth and efficient.
...
1. **Fork the upstream repository**: Click the "Fork" button on https://github.com/birongliu/investorly
2. **Clone your fork**: Clone the forked repository (NOT the upstream repository) to your local machine.
    ```sh
    git clone https://github.com/[your-username]/investorly.git
    cd investorly
    ```
3. **Add the upstream repository as a remote**: This will allow you to pull changes from the [upstream repository](https://github.com/birongliu/investorly).
    ```sh
    git remote add upstream https://github.com/birongliu/investorly.git
    ```

Note: We use two primary (protected) branches in the [upstream repository](https://github.com/birongliu/investorly):
  - `main`: The stable release branch.
  - `dev`: The development branch where the latest changes are consolidated.

## Using GitHub Issues

1. **Create an Issue in the upstream repository**: Before starting work on a new feature or bugfix, create a GitHub Issue in the [upstream repository](https://github.com/birongliu/investorly) to describe the work to be done.
